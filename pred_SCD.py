...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--test_dir', required=False, default='/HOME/JL1_data/test', help='directory to test images')
        parser.add_argument('--pred_dir', required=False, default='/HOME/results/SCD', help='directory to output masks')
        parser.add_argument('--chkpt_path', required=False, default='/HOME/BGSNet.pth')
