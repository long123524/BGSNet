...
root = '/HOME/code/BGSNet_SCD/JL1_data'
...
class Data(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return F.to_tensor(img_A), F.to_tensor(img_B), torch.from_numpy(label_A), torch.from_numpy(label_B), torch.from_numpy(label_C)
